...
class ONDCClient:
    ...
    def create_context(self, action, request_context=None):
        ...
        context = {
            ...
            "message_id": str(uuid.uuid4()),  # Always unique per callback
    ...
    def add_payment_terms(self, order):
        ...
        # ----- 7. Cancellation Terms (ONDC RET10 on_init requirement) -----
        order["cancellation_terms"] = [
            ...
            },
            {
                "fulfillment_state": {
                    "descriptor": {
                        "code": "Packed",
                        "short_desc": "Cancellation charges may apply after packing",
                    }
                },
